...
knitr::kable(rnd_table, "html", col.names = c("Randomization", "Purpose")) %>%
  ...
  row_spec(c(0, 2, 4), bold = TRUE, color = "white", background = params$tbl_color1) %>%
  row_spec(c(1, 3), bold = TRUE, color = "white", background = params$tbl_color2)
```
...
tribble(
  ...
  row_spec(c(0, 2, 4, 6), bold = TRUE, color = "white", background = params$tbl_color1) %>%
  row_spec(c(1, 3, 5, 7), bold = TRUE, color = "white", background = params$tbl_color2)
```
...
tribble(
  ...
  row_spec(c(0, 2, 4, 6, 8), bold = TRUE, color = "white", background = params$tbl_color1) %>%
  row_spec(c(1, 3, 5, 7, 9), bold = TRUE, color = "white", background = params$tbl_color2)
```
